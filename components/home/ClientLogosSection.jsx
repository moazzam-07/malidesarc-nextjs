            ...
            >
              <div className="cl-hd">
                <p className="sub rv d2 in">
                  From commercial workplaces and hospitality environments to residential interiors, our clients trust MaliDesarc for thoughtful design, reliable execution, and end-to-end interior contracting.
                </p>
              </div>
            </div>
          </div>
